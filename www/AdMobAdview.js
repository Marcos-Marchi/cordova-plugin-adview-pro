...
admobExport.getAdSettings = function(successCallback, failureCallback){
  cordova.exec(successCallback, failureCallback, 'AdMobAdview', 'getAdSettings', []);
};
...
admobExport.setOptions = function(options, successCallback, failureCallback) {
  if(typeof options === 'object') {
    cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'setOptions', [options] );
  } else {
...
admobExport.createBanner = function(args, successCallback, failureCallback) {
  ...
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'createBanner', [ options ] );
};

admobExport.removeBanner = function(successCallback, failureCallback) {
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'removeBanner', [] );
};

admobExport.hideBanner = function(successCallback, failureCallback) {
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'hideBanner', [] );
};

admobExport.showBanner = function(position, successCallback, failureCallback) {
  if(typeof position === 'undefined') position = 0;
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'showBanner', [ position ] );
};

admobExport.showBannerAtXY = function(x, y, successCallback, failureCallback) {
  if(typeof x === 'undefined') x = 0;
  if(typeof y === 'undefined') y = 0;
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'showBannerAtXY', [{x:x, y:y}] );
};
...
admobExport.prepareInterstitial = function(args, successCallback, failureCallback) {
  ...
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'prepareInterstitial', [ options ] );
};

admobExport.showInterstitial = function(successCallback, failureCallback) {
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'showInterstitial', [] );
};

admobExport.isInterstitialReady = function(successCallback, failureCallback) {
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'isInterstitialReady', [] );
};
...
admobExport.prepareRewardVideoAd = function(args, successCallback, failureCallback) {
  ...
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'prepareRewardVideoAd', [ options ] );
};

admobExport.showRewardVideoAd = function(successCallback, failureCallback) {
  cordova.exec( successCallback, failureCallback, 'AdMobAdview', 'showRewardVideoAd', [] );
};
